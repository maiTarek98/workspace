  ...
  <section class="content-header">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{Url('admin/customer/create')}}">أضافة اعمال جديدة</a></li>        
      </ol>
    </section>
          ...
          <div class="box-body">
            ...
            <tbody>
              ...
              <tr>
                ...
                @if($data->logo)
                 <img class="img-responsive" style="width:100px;height:70px;" src="/images/{{ $data->logo }}" alt="type of hagama">
            @endif</td>    
              </td>          
                ...
                <td class="text-center">
                 <a href="{{url('admin/customer/'.$data->id.'/edit')}}" class="btn btn-primary fa fa-pencil-square-o" ></a>
               </td>
                <td class="text-center">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <h3 class="text-center ">
                           Do You Want to Delete  :  {{ $data->logo }} ? </h3>
                      </div>
