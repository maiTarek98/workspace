  ...
  <section class="content-header">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{Url('admin/services/create')}}">أضافة مقال جديدة</a></li>        
      </ol>
    </section>
          ...
          <div class="box-body">
             <table id="example1" class="table table-bordered table-striped">
              <thead>
                <tr>
                  ...
                  <th class="text-center">محتوي المقال  </th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center"> {{ $data->postTitle}}</td>
                ...
                <td class="text-center">
                 <a href="{{url('admin/services/'.$data->id.'/edit')}}" class="btn btn-primary fa fa-pencil-square-o" ></a>
               </td>
                <td class="text-center">
                  <form method="post" action="{{url('admin/services/'.$data->id)}}">
                  {{csrf_field()}}
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <h3 class="text-center ">
                           Do You Want to Delete  :  {{ $data->postTitle }} ? </h3>
                      </div>
