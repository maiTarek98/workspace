  ...
  <section class="content-header">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{Url('admin/gallery/create')}}">أضافة اعمال جديدة</a></li>        
      </ol>
    </section>
          ...
          <div class="box-body">
            ...
            <tbody>
              ...
              <tr>
                ...
                @if($data->imgs)
                 <img class="img-responsive" style="width:100px;height:70px;" src="/images/{{ $data->imgs }}" alt="type of hagama">
            @endif</td>    
              </td>    
              <td class="text-center">
                 <img class="img-responsive" style="width:100px;height:70px;" src="/images/{{ $data->sectionImgs }}" alt="type of hagama">
            </td>    
              </td>   
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <h3 class="text-center ">
                           Do You Want to Delete  :  {{ $data->imgs }} ? </h3>
                      </div>
